        ...
        <tr>
            <td>
                <div style="height: 100%; background-color: #DFF9FF; border-radius: 15px; padding: 16px 32px; margin: auto;">
                    ...
                    <a href="https://www.veplo.it/orders/${order.id}" target="_blank" style="cursor: pointer;"><button style="background-color: #37D1A9; border: none; padding: 12px 24px; border-radius: 5px; color: white; font-size: 16px; font-weight: 600; margin-top: 6px; margin-bottom:8px;">MONITORA ORDINE</button></a>
                </div>
            </td>
        </tr>
        <tr>
